...
class voronoicell_base {
	public:
		...
		void output_neighbors(cele3d *faces,int ids,bool later=false);
		...
		void print_edges();
		void print_edges(vector<vector<int> > &realations);
		void label_facets();
		void check_facets();
...
class neighbor_none {
	public:
		...
		inline void print_edges(vector<int> temp) {};
		/** This is a blank placeholder function that does nothing. */
		...
		inline void neighbors(cele3d *faces,int ids,bool later) {};
		/** This is a blank placeholder function that does nothing. */
...
class neighbor_track {
	public:
		...
		inline void set_to_aux2(int j);
		inline void print_edges(int i);
		inline void print_edges(vector<int> &temp, int i);
		inline void allocate_aux1(int i);
		inline void switch_to_aux1(int i);
		inline void copy_to_aux1(int i,int m);
		inline void set_to_aux1_offset(int k,int m);
               inline void neighbors(vector<int> &kaimynai);
		inline void neighbors(ostream &os,bool later);
		inline void neighbors(cele3d *faces,int ids,bool later);
		inline void label_facets();
		inline void check_facets();
