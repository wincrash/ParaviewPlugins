...
#ifndef _vtkVoronoi2DWithIncircle_H
#define _vtkVoronoi2DWithIncircle_H
...
class VTK_GRAPHICS_EXPORT vtkVoronoi2DWithIncircle: public vtkPolyDataAlgorithm {
public:
    vtkTypeRevisionMacro(vtkVoronoi2DWithIncircle, vtkPolyDataAlgorithm)
    static vtkVoronoi2DWithIncircle *New();

    vtkVoronoi2DWithIncircle();
    virtual ~vtkVoronoi2DWithIncircle();vtkSetMacro(radius_,string)    
...
protected:
    ...
    void GetIncircleStruct(int main_point,vector<InCircleStruct> &struktura);
    int LocalRun2D();
...
#endif  /* _vtkVoronoi2DWithIncircle_H */
