...
#ifndef _vtkVoronoiGlobal3D_H
#define _vtkVoronoiGlobal3D_H
...
class VTK_GRAPHICS_EXPORT vtkVoronoiGlobal3D: public vtkPolyDataAlgorithm {
public:
vtkTypeRevisionMacro(vtkVoronoiGlobal3D, vtkPolyDataAlgorithm)
	static vtkVoronoiGlobal3D *New();

	vtkVoronoiGlobal3D();
	virtual ~vtkVoronoiGlobal3D();vtkSetMacro(radius_,string)
	;
